...
const sections: CommandSection[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { label: "Forums", icon: "F", action: "/forums" },
      { label: "Snippets", icon: "<", action: "/snippets" },
      { label: "Playlists", icon: "P", action: "/playlists" },
      { label: "Marketplace", icon: "$", action: "/marketplace" },
      { label: "Chat Rooms", icon: "#", action: "/chat" },
      { label: "Polls", icon: "?", action: "/polls" },
      { label: "Announcements", icon: "!", action: "/announcements" },
      { label: "Wiki", icon: "W", action: "/wiki" },
